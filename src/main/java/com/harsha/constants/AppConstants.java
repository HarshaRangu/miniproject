package com.harsha.constants;

public class AppConstants {

	public static final String EMP_STR = "";

	public static final String PLAN_SAV_SUCC = "planSaveSucc";

	public static final String PLAN_SAV_FAIL = "planSaveFail";
	...
	public static final String PLAN_STATUS_CHANGE_SUCC = "planStatusChange";
